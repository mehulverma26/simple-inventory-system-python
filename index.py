...
def Database():
    ...
    cursor.execute("SELECT * FROM `admin` WHERE `username` = 'mehulverma26' AND `password` = 'mehulverma'")
    if cursor.fetchone() is None:
        cursor.execute("INSERT INTO `admin` (username, password) VALUES('mehulverma26', 'mehulverma')")
        conn.commit()
